...
public class ModStats {
    ...
    public static final Identifier CONSUME_SAPPHIRE = new Identifier(FrolicsChaosMod.MOD_ID, "consume_sapphire");
    public static final Identifier CONSUME_RUBY = new Identifier(FrolicsChaosMod.MOD_ID, "consume_ruby");
    public static final Identifier DOUBLE_JUMPS = new Identifier(FrolicsChaosMod.MOD_ID, "double_jumps");
    public static final Identifier AFK_BLOCKS_PLACED = new Identifier(FrolicsChaosMod.MOD_ID, "afk_blocks_placed");
    public static final Identifier SPAWNERS_SILK_TOUCHED = new Identifier(FrolicsChaosMod.MOD_ID, "spawners_silk_touched");
    public static final Identifier SCULK_SILK_TOUCHED = new Identifier(FrolicsChaosMod.MOD_ID, "sculk_silk_touched");

    // register all the stats
    public static void registerStats() {

        System.out.println("\n--Frolic's Chaos Registering Statistics!---");
